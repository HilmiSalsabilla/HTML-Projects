...
const projects = [
    ...
    { id: 16, name: "English Dictionary Application" },
    { id: 17, name: "Indonesian Dictionary Application" },
    ...
    { id: 24, name: "Prime and Non-Prime Number" },
    { id: 25, name: "Counter Application" },
    { id: 26, name: "Age Calculator" },
    { id: 27, name: "Date and Time Widget" },
